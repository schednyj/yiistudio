...
use admin\modules\comment\assets\CommentAsset;
...
class Comment extends Widget
{
    ...
    /**
     * @var string the view file that will render the comment tree and form for posting comment
     */
    public $commentView = '@admin/modules/comment/widgets/views/comment/index';
    ...
    /**
     * @var null|int maximum comment level, level starts from 1, null - unlimited level;
     */
    public $maxLevel = 10;
    ...
    public function run()
    {
        $commentClass = Yii::$app->getModule('admin')->activeModules['comment']->settings['commentModelClass'];
