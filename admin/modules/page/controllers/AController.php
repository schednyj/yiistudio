...
class AController extends \admin\base\admin\Controller
{
    ...
    public function actionCreate($slug = null)
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            if(Yii::$app->request->isAjax){
                ...
                if($model->save()){
                    $this->flash('success', Yii::t('admin/page', 'Страница создана'));
    ...
    public function actionEdit($id)
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            if(Yii::$app->request->isAjax){
                ...
                if($model->save()){
                    $this->flash('success', Yii::t('admin/page', 'Страница обновлена'));
                }
                else{
    ...
    public function actionDelete($id)
    {
        ...
        return $this->formatResponse(Yii::t('admin/page', 'Страница удалена'));
    }
}