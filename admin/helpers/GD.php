...
class GD {
    ...
    public function resize($width = null, $height = null) {
        ...
        imagecopyresampled(
                $resizedImage, $this->_image, 0, 0, 0, 0, $newWidth, $newHeight, $this->_width, $this->_height
        );
    ...
    public function cropThumbnail($width, $height) {
        ...
        imagecopyresampled(
                $resizedImage, $this->_image, 0, 0, round(($this->_width - $newWidth) / 2), round(($this->_height - $newHeight) / 2), $width, $height, $newWidth, $newHeight
        );
